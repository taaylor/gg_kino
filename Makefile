...
vm-up-server:
	sudo docker compose --profile production up -d --build kibana embedding-etl recs-profile nl-consumer nginx notification auth-api pg-import postgres recs-profile embedding-service content-actions-api kafka-init
